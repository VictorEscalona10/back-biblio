...
def login_page(page: ft.Page):
    ...
    title = ft.Text("Iniciar sesión", size=30, weight=ft.FontWeight.NORMAL, color=ft.colors.WHITE, text_align=ft.TextAlign.CENTER)
    message = ft.Text(value="", size=15, color=ft.colors.GREEN)
    ...
    register_button = ft.ElevatedButton("Registrarse", on_click=show_register, color=ft.colors.WHITE, bgcolor="#212121", width=118,height=35, style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=3)))
    ...
    col = ft.Column(
        [
            ...
            ft.Row(
                [
                    ft.Text("¿No tienes cuenta?", size=20, color='#ffffff'),
                    register_button
                ],
